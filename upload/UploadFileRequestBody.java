...
public class UploadFileRequestBody extends RequestBody {
    ...
    private FileUploadObserver<BaseBean<UploadReq>> fileUploadObserver;

    public UploadFileRequestBody(File file, FileUploadObserver<BaseBean<UploadReq>> fileUploadObserver) {
